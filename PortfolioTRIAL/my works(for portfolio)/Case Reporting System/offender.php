...
<div class="container">
    ...
    <table>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>{$row['o_id']}</td>";
            echo "<td>{$row['o_date_of_birth']}</td>";
            echo "<td>{$row['o_age']}</td>";
            echo "<td>{$row['o_sex']}</td>";
            echo "<td>{$row['o_yearandsection']}</td>";
            echo "<td>{$row['o_adviser']}</td>";
            echo "<td>{$row['o_case']}</td>";
...
<form action='update_report.php' method='post'>
    ...
    <input type='text' name='edito_name' placeholder='Enter Name' value='" . $row['o_name'] . "' required/>
    <input type='text' name='edito_id' placeholder='Enter Relationship to victim' value='" . $row['o_id'] . "' required/>
    <input type='text' name='edito_date_of_birth' placeholder='Enter Address' value='" . $row['o_date_of_birth'] . "' required/>
    <input type='text' name='edito_age' placeholder='Enter Contact Number' value='" . $row['o_age'] . "' required/>
    <input type='text' name='edito_sex' placeholder='Enter Case' value='" . $row['o_sex'] . "' required/>
    <input type='text' name='edito_yearandsection' placeholder='Enter Address' value='" . $row['o_yearandsection'] . "' required/>
    <input type='text' name='edito_adviser' placeholder='Enter Contact Number' value='" . $row['o_adviser'] . "' required/>
    <input type='text' name='edito_case' placeholder='Enter Case' value='" . $row['o_case'] . "' required/>
