...
$sql = "SELECT * FROM students_cases";
...
<div class="container">
    ...
    <table>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>{$row['victims_name']}</td>";
            echo "<td>{$row['offenders_name']}</td>";
            echo "<td>{$row['date']}</td>";
...
<form action='update_report.php' method='post'>
    ...
    <input type='text' name='editvictims_name' placeholder='Enter Name' value='" . $row['victims_name'] . "' required/>
    <input type='text' name='editoffenders_name' placeholder='Enter Relationship to victim' value='" . $row['offenders_name'] . "' required/>
    <input type='text' name='editdate' placeholder='Enter Address' value='" . $row['date'] . "' required/>
    <input type='text' name='editstatus' placeholder='Enter Contact Number' value='" . $row['status'] . "' required/>
